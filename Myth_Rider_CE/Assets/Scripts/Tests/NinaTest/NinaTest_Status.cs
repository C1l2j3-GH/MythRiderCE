...
public class NinaTest_Status : MonoBehaviour
{
    [Header("Status")]
    [Header("Preset")]
    ...
    public NinaTest_BaseForm _currentForm;
    public NinaTest_Form1 _form1 = new();
    public NinaTest_Form2 _form2 = new();

    public static NinaTest_Status _nT_S_Instance;

    void Awake() // Singeton
    {
        if (_nT_S_Instance == null)
        {
            _nT_S_Instance = this;
        }
        else
    ...
    public void SwitchForm(NinaTest_BaseForm form)
    {
        _currentForm = form;
        form.EnterForm(this);
    }
